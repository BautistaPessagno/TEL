#ifndef AST_BUILDER_HEADER
#define AST_BUILDER_HEADER

#include "AbstractSyntaxTree.h"

/*
 * Parser-neutral AST construction API shared by the TEL and C frontends.
 * Ownership of every pointer argument is transferred to the returned node.
 */
...
VariableDeclaration * VariableDeclarationSemanticAction(
	char * name,
	Type * type,
	Expression * initializer,
	bool isStatic);
VariableDeclarationList * SingletonVariableDeclarationListSemanticAction(
	VariableDeclaration * declaration);
VariableDeclarationList * AppendVariableDeclarationListSemanticAction(
...
ParameterList * AppendParameterListSemanticAction(
	ParameterList * parameterList,
	Parameter * parameter);
FunctionDeclaration * FunctionDeclarationSemanticAction(
	char * name,
...
AggregateDeclaration * AggregateDeclarationSemanticAction(
	AggregateKind kind,
	char * name,
...
EnumMemberList * AppendEnumMemberListSemanticAction(
...
PreprocessorDirective * PreprocessorDirectiveSemanticAction(
...
Expression * BinaryExpressionSemanticAction(
	Expression * left,
...
ExpressionList * AppendExpressionListSemanticAction(
...
ProgramItem * EmptyProgramItemSemanticAction(void);
ProgramItemList * SingletonProgramItemListSemanticAction(ProgramItem * item);
ProgramItemList * AppendProgramItemListSemanticAction(
	ProgramItemList * itemList,
	ProgramItem * item);
ProgramItemList * ConcatenateProgramItemListSemanticAction(
	ProgramItemList * first,
	ProgramItemList * second);
...
ForStatement * ForStatementSemanticAction(
	Expression * initializer,
	Expression * condition,
	Expression * update,
	StatementList * body);
ForStatement * ForStatementFromFordSemanticAction(
	char * iteratorName,
	Expression * start,
	Expression * end,
	StatementList * body);
...
SwitchCase * AppendSwitchCaseSemanticAction(
	SwitchCase * caseList,
...
Statement * BreakStatementSemanticAction(void);
Statement * InlineCStatementSemanticAction(char * code);
Statement * ContinueStatementSemanticAction(void);
Statement * EmptyStatementSemanticAction(void);
StatementList * SingletonStatementListSemanticAction(Statement * statement);
StatementList * AppendStatementListSemanticAction(
